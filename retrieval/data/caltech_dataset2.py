...
sound_items = [
    "airplanes", "helicopter", "watch", "wild_cat", "car_side", 
    "ant", "butterfly", "dragonfly", "ferry", "laptop", 
    "llama", "dalmatian"
]
...
#  ---------------------------------------------------
    ...
    def _readTXT(self, txtPath):
        ...
        for line in self.files:
            cls_name = line.split("\t")[0].split("/")[-2]
            if cls_name in sound_items:
